...
char Date[16];
char Time[16];
char auth[] = "5aedeff145fe41c684560c25addc555f";
char ssid[] = "Room @ Vip";
char pass[] = "tdt@12345";
...
{
	if ((mondayfriday == 1) && (saturdaysunday == 0))
	{ 
		oldstatus = 1; 
	}

	if ((mondayfriday == 0) && (saturdaysunday == 1)) 
	{
		oldstatus = 2; 
	}

	if ((mondayfriday == 1) && (saturdaysunday == 1)) 
	{ 
		oldstatus = 3; 
	}
	...
	if ((mondayfriday == 0) && (saturdaysunday == 0) && (alldays == 0) && (uptoyou == 0)) 
	{ 
		oldstatus = 6; 
	}
}
